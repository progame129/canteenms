...
<div class="main">
    ...
    <div class="container_12">
      <div class="grid_12">
        ...
        <div class="menu_block">
          <nav>
            <ul class="sf-menu">
              <li class="current"><a href="<?php echo e(route('home-page')); ?>">Home</a></li>
  ...
  <div class="slider-relative">
    <div class="slider-block">
      <div class="slider">
        <ul class="items">
          <li><img src="<?php echo e(asset('theme/asset/images/slide.jpg')); ?>" alt="sdfsd"></li>
          <li><img src="<?php echo e(asset('theme/asset/images/slide1.jpg')); ?>" alt=""></li>
          <li class="mb0"><img src="<?php echo e(asset('theme/asset/images/slide2.jpg')); ?>" alt=""></li>
        </ul>
      </div>
    </div>
  </div>
  <div class="content page1">
    <div class="container_12">
      <div class="grid_7">
        <h2>Welcome</h2>
        <div class="page1_block col1"> <img src="<?php echo e(asset('theme/asset/images/welcome_img.png')); ?>" alt="">
      ...
      <div class="grid_12">
        <div class="car_wrap">
          ...
          <ul class="carousel1">
            <li>
              <div><img src="<?php echo e(asset('theme/asset/images/page1_img1.jpg')); ?>" alt="">
            ...
            <li>
              <div><img src="<?php echo e(asset('theme/asset/images/page1_img2.jpg')); ?>" alt="">
                <div class="col1 upp"> <a href="#">Lorem ipsum doamet consectet</a></div>
                <span> Dorem ipsum dolor amet consectetur</span>
                <div class="price">45$</div>
              </div>
            ...
            <li>
              <div><img src="<?php echo e(asset('theme/asset/images/page1_img3.jpg')); ?>" alt="">
                <div class="col1 upp"> <a href="#">Lorem ipsum doamet consectet</a></div>
                <span> Dorem ipsum dolor amet consectetur</span>
                <div class="price">45$</div>
              </div>
            ...
            <li>
              <div><img src="<?php echo e(asset('theme/asset/images/page1_img4.jpg')); ?>" alt="">
                <div class="col1 upp"> <a href="#">Lorem ipsum doamet consectet</a></div>
                <span> Dorem ipsum dolor amet consectetur</span>
                <div class="price">45$</div>
              </div>
...
<?php /* C:\xampp\htdocs\canteenms\resources\views/index.blade.php */ ?>