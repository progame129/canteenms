    ...
    <div class="container_12">
      <div class="grid_6">
        ...
        <p class="col2 inn1"><a href="#">
          ...
          <div class="menu">
          <div class="grid_3 alpha"> <img src="<?php echo e(asset('theme/asset/images/banhmiga.jpg')); ?>" style="width:209px;height:152px;" alt="" class="img_inner">
            <h3><a href="#">Bánh mì kẹp thịt gà chiên áp chảo</a></h3>
          ...
          <p class="col2 ">
          Bánh mì kẹp thịt gà chiên áp chảo với thịt gà ướp ít nguyên liệu rồi chiên áp chảo cho chín, thái nhỏ. Bánh mì kẹp thịt gà đồ chua cùng các phụ liệu ớt, ngò rí tùy thích.
          </p>
        <div class="clear"></div>
      </div>
...
<?php /* C:\xampp\htdocs\canteenms\resources\views/banhmiga.blade.php */ ?>