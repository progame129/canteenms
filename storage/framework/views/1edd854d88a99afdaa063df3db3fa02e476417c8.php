...
<link rel="stylesheet" href="<?php echo e(asset('theme/asset/css/slider.css')); ?>">
...
<script src="<?php echo e(asset('theme/asset/js/jquery.carouFredSel-6.1.0-packed.js')); ?>"></script>
<script src="<?php echo e(asset('theme/asset/js/tms-0.4.1.js')); ?>"></script>
<script>
...
<div class="main">
  <header>
    <div class="container_12">
      <div class="grid_12">
        <h1><a href="index.html"><img src="<?php echo e(asset('theme/asset/images/logo.png')); ?>" alt=""></a></h1>
        <div class="menu_block">
          <nav>
            <ul class="sf-menu">
              <li class="with_ul"><a href="<?php echo e(route('home-page')); ?>">Home</a></li>
              <li class="current"><a href="<?php echo e(route('about-page')); ?>">About Us</a></li>
              <li class="with_ul"><a href="<?php echo e(route('menu-page')); ?>">Menu</a>
              </li>
  ...
  <div class="content">
    <div class="container_12">
      <div class="grid_5">
        <h2>About Us</h2>
        <img src="<?php echo e(asset('theme/asset/images/page2_img1.jpg')); ?>" alt="" class="img_inner">
      ...
      <div class="grid_5 prefix_2">
        ...
        <ul class="carousel2">
          ...
          <li>
            <blockquote> <img src="<?php echo e(asset('theme/asset/images/page2_img2-1.png')); ?>" alt="">
              <div class="extra_wrapper">
      ...
      <div class="clear"></div>
      <div class="chefs">
        <div class="grid_3"> <img src="<?php echo e(asset('theme/asset/images/page2_img3.jpg')); ?>" alt="" class="img_inner">
        ...
        <div class="grid_3"> <img src="<?php echo e(asset('theme/asset/images/page2_img4.jpg')); ?>" alt="" class="img_inner">
        ...
        <div class="grid_3"> <img src="<?php echo e(asset('theme/asset/images/page2_img5.jpg')); ?>" alt="" class="img_inner">
        ...
        <div class="grid_3"> <img src="<?php echo e(asset('theme/asset/images/page2_img6.jpg')); ?>" alt="" class="img_inner">
...
<?php /* C:\xampp\htdocs\canteenms\resources\views/about.blade.php */ ?>