    ...
    <div class="container_12">
      <div class="grid_6">
        ...
        <p class="col2 inn1"><a href="#">
          ...
          <p class="col2 ">
          Bánh mì là một thực phẩm chế biến từ bột mì từ ngũ cốc được nghiền ra trộn với nước, thường là bằng cách nướng. Trong suốt quá trình lịch sử nó đã được phổ biến trên toàn thế giới và là một trong những loại thực phẩm nhân tạo lâu đời nhất, và rất quan trọng kể từ lúc ban đầu của ngành nông nghiệp.          </p>
        <div class="clear"></div>
      </div>
...
<?php /* C:\xampp\htdocs\canteenms\resources\views/banhmithit.blade.php */ ?>