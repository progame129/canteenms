        ...
        <div class="menu_block">
          <nav>
            <ul class="sf-menu">
              ...
              <li><a href="<?php echo e(route('menu-page')); ?>">Menu</a></li>
              <li class="current"><a href="<?php echo e(route('new-page')); ?>">News</a></li>
  ...
  <div class="content">
    <div class="container_12">
      <div class="grid_7">
        ...
        <div class="news"> <img src="<?php echo e(asset('theme/asset/images/page5_img1.jpg')); ?>" alt="" class="img_inner fleft">
        ...
        <div class="news mb0"> <img src="<?php echo e(asset('theme/asset/images/page5_img2.jpg')); ?>" alt="" class="img_inner fleft">
          <div class="extra_wrapper">
...
<?php /* C:\xampp\htdocs\canteenms\resources\views/new.blade.php */ ?>