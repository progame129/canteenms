...
<div class="main">
  <header>
    ...
    <div class="container_12">
      <div class="grid_12">
        <h1><a href="<?php echo e(route('home-page')); ?>"><img src="<?php echo e(asset('theme/asset/images/logo.jpg')); ?>" alt=""></a></h1>
    ...
    <div class="container_12">
      <div class="grid_6">
        ...
        <p class="col2 inn1"><a href="#">
          ...
          <div class="menu">
          <div class="grid_3 alpha"> <img src="{{asset('theme/asset/images/7up.jpg')}}" style="width:209px;height:152px;" alt="" class="img_inner">
            <h3><a href="#">7up</a></h3>
          ...
          <p class="col2 ">
         7UP là một nhãn hiệu đồ uống nhẹ vị chanh không chứa caffein. Bản quyền nhãn hiệu thuộc về Dr Pepper Snapple Group của Mỹ và PepsiCo (được nhượng giấy phép) ở bên ngoài nước Mỹ. Logo 7Up bao gồm một chấm đỏ nằm giữa "7" và "Up".          </p>
        <div class="clear"></div>
      </div>
