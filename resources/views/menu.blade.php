  ...
  <div class="content">
    <div class="container_12">
      <div class="grid_6">
        ...
        <div class="menu">
          <div class="grid_3 alpha"> <img src="{{asset('theme/asset/images/page3_img1.jpg')}}" alt="" class="img_inner">
            <h3><a href="#">Donec</a></h3>
          </div>
          <div class="grid_3 omega"> <img src="{{asset('theme/asset/images/page3_img2.jpg')}}" alt="" class="img_inner">
            <h3><a href="#">Murtyio</a></h3>
          </div>
          <div class="grid_3 alpha"> <img src="{{asset('theme/asset/images/page3_img3.jpg')}}" alt="" class="img_inner">
            <h3><a href="#">Holity as Polfh</a></h3>
          </div>
          <div class="grid_3 omega"> <img src="{{asset('theme/asset/images/page3_img4.jpg')}}" alt="" class="img_inner">
            <h3><a href="#">Kiperty</a></h3>
          </div>
          <div class="grid_3 alpha"> <img src="{{asset('theme/asset/images/page3_img5.jpg')}}" alt="" class="img_inner">
            <h3 class="mb0"><a href="#">Gyloit</a></h3>
          </div>
          <div class="grid_3 omega"> <img src="{{asset('theme/asset/images/page3_img6.jpg')}}" alt="" class="img_inner">
