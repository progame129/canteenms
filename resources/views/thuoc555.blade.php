    ...
    <div class="container_12">
      <div class="grid_6">
        ...
        <p class="col2 inn1"><a href="#">
          ...
          <div class="menu">
          <div class="grid_3 alpha"> <img src="{{asset('theme/asset/images/555.jpg')}}" style="width:209px;height:152px;" alt="" class="img_inner">
            <h3><a href="#">Thuốc lá 555</a></h3>
