        ...
        <div class="menu_block">
          <nav>
            <ul class="sf-menu">
              ...
              <li class="current"><a href="{{ route('new-page') }}">News</a></li>
  ...
  <div class="content">
    <div class="container_12">
      <div class="grid_7">
        ...
        <div class="news"> <img src="{{asset('theme/asset/images/page5_img1.jpg')}}" alt="" class="img_inner fleft">
        ...
        <div class="news mb0"> <img src="{{asset('theme/asset/images/page5_img2.jpg')}}" alt="" class="img_inner fleft">
          <div class="extra_wrapper">
